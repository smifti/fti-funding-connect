...
export default function PackageDetailContent({
  pkg, applicantCount, mode = 'agency',
  ...
  // เฉพาะ mode='public' — ลิงก์ไปหน้า login/สมัครสมาชิก แทนปุ่ม onClick (เพราะคนดูยังไม่ login)
  applyHref?: string
}) {
  ...
  // ปุ่มแชร์ — ชี้ไปหน้าสาธารณะ /p/<id> เสมอ (เข้าดูได้โดยไม่ต้อง login ไม่ว่าจะแชร์จากที่ไหน)
  const [shareCopied, setShareCopied] = useState(false)
  function getShareUrl() {
    if (typeof window === 'undefined') return ''
    return `${window.location.origin}/p/${pkg.id}`
  }
  ...
  const hideCountBadges = mode === 'sme' || mode === 'public'
  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap' }}>
      ...
      <div style={{
        ...
        {/* ปุ่มสนใจ/สมัคร สำหรับผู้เยี่ยมชมที่ยังไม่ login (หน้าสาธารณะ) — กดแล้วไปหน้า login/สมัครสมาชิก */}
        {mode === 'public' && applyHref && (
        ...
        {(mode === 'sme' || mode === 'public') && agencyContact && (
